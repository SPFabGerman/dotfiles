;;; fabcustom-theme.el --- Custom face theme for Emacs
...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   'fabcustom
   `(default ((,class (:background "#282c34" :foreground "#eceff4"))))
   ...
   ;; Font lock faces
   `(font-lock-builtin-face ((,class (:foreground "#b48ead"))))
   `(font-lock-comment-face ((,class (:foreground "#5c667a"))))
   `(font-lock-constant-face ((,class (:foreground "#b3ce9c"))))
   `(font-lock-negation-char-face ((,class (:foreground "#dbbb7b"))))
   `(font-lock-function-name-face ((,class (:foreground "#81a1c1"))))
   `(font-lock-keyword-face ((,class (:foreground "#b48ead" :weight bold))))
   `(font-lock-string-face ((,class (:foreground "#93ae7c"))))
   `(font-lock-type-face ((,class (:foreground "#76b3c5" :weight bold))))
   `(font-lock-variable-name-face ((,class (:foreground "#88c0d0"))))
