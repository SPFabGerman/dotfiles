------------------------------------------------
-- Awesome theme which follows wal lua config --
-- Adapted from the default xresources theme  --
--   by Yauhen Kirylau                        --
------------------------------------------------
...
local xrdb = protected_call(dofile, gfs.get_xdg_cache_home().."wal/colors.lua")
