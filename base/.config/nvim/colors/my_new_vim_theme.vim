...
let g:colors_name="my_new_vim_theme"
...
call GUIHighlight("VertSplit", "darkgrey", -1, "Bold")
call HighlightLink("FloatBorder", "NormalFloat")
...
let s:colorfunc=darkblue
let s:colorvar=lightblue
let s:colortype=darkcyan
let s:colorpreproc=darkmagenta

call GUIHighlight("Comment", lightgrey, -1, "None")
call GUIHighlight("Ignore", lightgrey, -1, "None")

call GUIHighlight("Constant", lightgreen, -1, "None")
call GUIHighlight("String", darkgreen, -1, "None")
call GUIHighlight("Identifier", s:colorvar, -1, "None")
call GUIHighlight("Function", s:colorfunc, -1, "None")
call GUIHighlight("Statement", lightmagenta, -1, "None")
call GUIHighlight("PreProc", s:colorpreproc, -1, "None")
call GUIHighlight("Type", s:colortype, -1, "None")
call GUIHighlight("Typedef", s:colortype, -1, "None")
...
call GUIHighlight("Tag_f", s:colorfunc, -1, "underline") "Functions
call GUIHighlight("Tag_v", s:colorvar, -1, "underline") "Variables
call GUIHighlight("Tag_t", s:colortype, -1, "underline") "Types
...
call GUIHighlight("Tag_d", s:colorpreproc, -1, "underline") "Macro
...
" Gitsigns
call GUIHighlight("GitSignsAdd", darkgreen, -1, "bold")
call GUIHighlight("GitSignsChange", darkblue, -1, "bold")
call GUIHighlight("GitSignsDelete", darkred, -1, "bold")
